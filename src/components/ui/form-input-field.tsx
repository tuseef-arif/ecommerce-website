...
const defaultInputClassName =
  "peer min-h-[3.5rem] w-full rounded-lg border border-neutral-300 bg-white px-3 pb-1.5 pt-5 text-sm leading-6 text-neutral-900 outline-none ring-0 transition-colors placeholder:text-transparent focus:border-[var(--store-brand-primary)] focus:ring-0";
